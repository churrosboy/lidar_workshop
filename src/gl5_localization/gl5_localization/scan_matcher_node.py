...
class ScanMatcherNode(Node):
    ...
    # 스캔을 키프레임에 정합해 포즈 갱신, 많이 움직였으면 키프레임 교체
    def scan_callback(self, msg: LaserScan) -> None:
        ...
        if msg.header.frame_id != self.base_frame:
            ...
            return
        # Bag replay restarting (--loop) sends older stamps: start the odometry over instead of
        # matching the first scan of the bag against the keyframe from its end.
