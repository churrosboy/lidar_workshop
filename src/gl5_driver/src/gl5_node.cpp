...
class Gl5Node : public rclcpp::Node {
 ...
 private:
  // lidar_type, IP/포트, 프레임, 거리 범위 파라미터 읽기
  ...
  // SDK 프레임 콜백: LaserScan과 PointCloud2 변환 및 발행
